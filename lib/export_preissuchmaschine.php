...
* @author abierbrauer
*/
class export_preissuchmaschine {
	...
	public function __construct($directory) {
		...
		$this->export_path = $this->output_directory . '/' . 'preissuchmaschine_'.Mage::app()->getStore()->getCode().'_'.$this->num_file.'.csv';
	...
	public function write_header() {
		...
		array_push($header_data,"Bestellnummer");
		array_push($header_data,"Hersteller");
		array_push($header_data,"Bezeichnung");
		array_push($header_data,"Preis");
		array_push($header_data,"Lieferzeit");
		array_push($header_data,"ProduktLink");
		array_push($header_data,"FotoLink");
		array_push($header_data,"Beschreibung");
		array_push($header_data,"VersandNachname");
		array_push($header_data,"VersandKreditkarte");
		array_push($header_data,"VersandLastschrift");
		array_push($header_data,"VersandBankeinzug");
		array_push($header_data,"VersandRechnung");
		array_push($header_data,"VersandVorkasse");
		array_push($header_data,"EANCode");
		array_push($header_data,"Gewicht");
	...
	public function write_row(&$prepared_product,&$product) {
		...
		echo "------------------------------------------\n";
		echo 'preissuchmaschine: product name:'.$name."\n";
