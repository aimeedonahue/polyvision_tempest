...
class export_preisroboter {
	...
	public function __construct($directory) {
		...
		$this->export_path = $this->output_directory . '/' . 'preisroboter_'.Mage::app()->getStore()->getCode().'_'.$this->num_file.'.csv';
	...
	public function write_row(&$prepared_product,&$product) {
		...
		echo "---------------------------------------\n";
		echo 'preisroboter: product name:'.$name."\n";
